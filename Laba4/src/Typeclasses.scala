...
object Typeclasses {
  ...
  implicit object SmashString extends Smash[String] {
    def apply(a: String, b: String): String = a.concat(b)
  }
  ...
  def main(args: Array[String]): Unit = {
    println(testReversableString("MacBook")) //ovoneL
    println(testSmashInt(20, 8)) //28
    println(testSmashDouble(2.5, 8.0)) //20.0
    println(testSmashString("Bakhishov ","Farid")) //Burger King
  }
}