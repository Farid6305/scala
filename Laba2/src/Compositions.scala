...
object Compositions {
  ...
  def main(args: Array[String]): Unit = {
    println("testCompose(f)(g)(h) = " +
      testCompose((x: Int) => x * 3)((x: Int) => x - 2)((x: Int) => x + x)(5))

    println("testMapFlatMap(f)(g)(h) = " +
      testMapFlatMap((x: Int) => Some(x * 3))((x: Int) => Some(x - 2))((x: Int) => x + x)(Some(5)))

    println("testForComprehension(f)(g)(h) = " +
      testForComprehension((x: Int) => Some(x * 3))((x: Int) => Some(x - 2))((x: Int) => x + x)(Some(5)))
  }
}
